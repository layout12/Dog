    ...
    function html5Upload() {	
    	...
    	/*sUploadURL= 'http://localhost:8787/resources/editor/sample/photo_uploader/file_uploader_html5.jsp'; 	//upload URL*/
    	sUploadURL= '/resources/editor/sample/photo_uploader/file_uploader_html5'; 	//upload URL
